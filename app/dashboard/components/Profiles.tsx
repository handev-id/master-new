...
export function mask(str: string) {
  if (str.length <= 2) return str; // Tidak perlu masking jika panjang ≤ 2
...
export const Data = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      setAccName(user?.rekeningName || "");
      setAccNumber(user?.rekeningNumber || "");
  ...
  return (
    <div className="bg-[#1f1f1f] p-4 rounded-lg shadow-xl shadow-[#A1A1A1]/15">
      ...
      <form className="flex w-full flex-col gap-5">
        ...
        {!user?.bankName && !user?.rekeningNumber && !user?.rekeningName ? (
          <>
            <div className="text-white flex flex-col gap-2 w-full">
              <p>Bank Name</p>
              <input
          ...
          <>
            ...
            <div className="text-white flex flex-col gap-2 w-full">
              <p>Account Name:</p>
              <p>{user.rekeningName}</p>
            </div>
            <div className="text-white flex flex-col gap-2 w-full">
              <p>Account Number:</p>
              <p>{mask(user.rekeningNumber)}</p>
            </div>
          </>
        )}
        <button
